...
import 'package:tool_theme/gen/gen.dart';
import 'package:tool_theme/theme.dart';

class FThemeData extends CoreThemeData {
  const FThemeData({
...
class FAppBarTheme extends CoreAppBarTheme {
  const FAppBarTheme({
...
class FTextTheme extends CoreTextTheme {
  const FTextTheme();
}
...
class FColorScheme extends CoreColorScheme {
...
class FDialogTheme extends CoreDialogTheme {
  const FDialogTheme({
...
class FDividerTheme extends CoreDividerTheme {
